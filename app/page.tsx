        ...
        <section className="relative px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
          <div className="mx-auto max-w-7xl text-center">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-gradient-rgb hover:bg-gradient-rgb-animated text-white font-semibold py-3 px-8 rounded-lg transition-all duration-300 glow-rgb">
                Shop Now
              </button>
              <button className="border-gradient-rgb hover:bg-white/10 text-white font-semibold py-3 px-8 rounded-lg transition-colors">
                Watch Demo
              </button>
            </div>
          </div>
        ...
        <section className="px-4 py-16 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="text-center mb-12">
              <span className="text-gradient-rgb text-lg font-medium">Experience the full spectrum of possibilities</span>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* LED Wristbands */}
              <div className="group relative overflow-hidden rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 p-8 hover:bg-white/10 transition-all duration-300 hover:border-gradient-rgb">
                ...
                <div className="relative z-10">
                  <div className="w-12 h-12 bg-accent/20 rounded-lg flex items-center justify-center mb-6 group-hover:glow-rgb transition-all duration-300">
                    <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                    </svg>
                  </div>
                  <h3 className="text-xl font-semibold text-white mb-4">LED Wristbands</h3>
                  <p className="text-gray-300 mb-6">
                    Sync to music, customizable colors, and perfect for crowds. Create stunning light shows that pulse with the beat.
                  </p>
                  <button className="text-gradient-rgb hover:text-gradient-rgb-animated font-medium transition-all duration-300">
                    Learn More →
                  </button>
                </div>
              </div>
              ...
              <div className="group relative overflow-hidden rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 p-8 hover:bg-white/10 transition-all duration-300 hover:border-gradient-rgb">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-xl font-semibold text-white mb-4">Smart Lamps</h3>
                  <p className="text-gray-300 mb-6">
