      ...
      <main className="flex-1">
        ...
        <section className="relative px-4 py-20 pb-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-5xl text-center">
            ...
            <p className="mx-auto max-w-3xl text-lg text-gray-300 mb-6">
              Sleek and satisfying. This custom, full RGB LED lamp brings a vibe into any room.
            </p>
            <ul className="mx-auto max-w-3xl text-lg text-gray-300 space-y-2">
          ...
          <div className="mx-auto max-w-4xl">
            ...
            <Link href="/lamps/halo" className="group block">
              <div className="p-12 text-center relative overflow-hidden">
                ...
                <h2 className="text-3xl font-bold text-white mb-4">HALO</h2>
